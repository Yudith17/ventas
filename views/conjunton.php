...
<div class="container-fluid m-0 p-3 mt-4 row">
                <div id="categoria" class="col-12 row m-0 container-fluid p-0">
                    <div id="imagenes_productos" class="col-2 row m-0">
                        <div id="imagen_principal" class="col-12 p-2" style="background: rgb(241, 239, 240); height: 600px;">
                                  ...
                                  <div class="filter-section" id="filter-category">
                                    ...
                                    <div id="category-options" class="collapse show">
                                      <div class="form-check">
                                        ...
                                        <label class="form-check-label" for="plus-size">Ropa de Niños y Niñas Plus</label>
                                      </div>
                                      <div class="form-check">
                                        <input class="form-check-input" type="radio" name="category" id="women-clothing" value="women-clothing">
                                        <label class="form-check-label" for="women-clothing">Ropa de Niños y Niñas</label>
                                      </div>
                                    </div>
                                  </div>
                                  ...
                                  <div class="filter-section" id="filter-size">
                                    ...
                                    <div id="size-options" class="collapse show">
                                      ...
                                      <div class="form-check">
                                        ...
                                        <label class="form-check-label" for="xs-size">Talla 2 al 6</label>
                                      </div>
                                      <div class="form-check">
                                        <input class="form-check-input" type="checkbox" id="s-size" value="s-size">
                                        <label class="form-check-label" for="s-size">Talla 8</label>
                                      </div>
                                      <div class="form-check">
                                        <input class="form-check-input" type="checkbox" id="m-size" value="m-size">
                                        <label class="form-check-label" for="m-size">talla 10</label>
                                      </div>
                                      <div class="form-check">
                                        <input class="form-check-input" type="checkbox" id="l-size" value="l-size">
                                        <label class="form-check-label" for="l-size">Talla 12</label>
                                      </div>
                                    </div>
                                  </div>
                    ...
                    <div id="detalles" class="col-10 p-2" style="background: rgb(241, 239, 240); height: 1000px; margin-top: 20px; overflow:scroll;">
                        <div class="container-fluid m-0 p-3 mt-4 row">
                            <div class="col-lg-3 col-md-4 col-sm-6 p-2">
                                <div class="card ">
                                <img src="https://img.ltwebstatic.com/images3_pi/2023/06/25/16877046846ba386375d003580f1928add31d6fc2b_thumbnail_720x.jpg" class="card-img-top" alt="...">
                                <div class="card-body">
                                  <h5 class="card-title">Card title</h5>
                                  <p class="card-text"> Nuevo Abrigo de Felpa de Otoño e Invierno Para Mujer es Simple, calido Y de Moda</p>
                                  <a href="detalle_carrito.html" class="btn btn-primary">Ver Detalles</a>
                            ...
                            <div class="col-lg-3 col-md-4 col-sm-6 p-2">
                                <div class="card ">
                                <img src="https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcRfFipS63pBZH2k7cz_HNYXfQP0_oK1OI6_XA&s" class="card-img-top" alt="...">
                                <div class="card-body">
                                  <h5 class="card-title">Card title</h5>
                            ...
                            <div class="col-lg-3 col-md-4 col-sm-6 p-2">
                                <div class="card ">
                                <img src="https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcTHAqIJaoPlcxaTHjEPY48d9Seb5t3bW-7mWQ&s" class="card-img-top" alt="...">
                                <div class="card-body">
                                  <h5 class="card-title">Card title</h5>
                                  <p class="card-text">Some quick example text to build on the card title and make up the bulk of the card's </p>
                                  <a href="detalle_carrito.html" class="btn btn-primary">Ver Detalles</a>
                            ...
                            <div class="col-lg-3 col-md-4 col-sm-6 p-2">
                                <div class="card ">
                                <img src="https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcS_ySFigVUgZI80LbnCv_LOtnZL3-o-hj4URg&s" class="card-img-top" alt="...">
                                <div class="card-body">
                                  <h5 class="card-title">Card title</h5>
                            ...
                            <div class="col-lg-3 col-md-4 col-sm-6 p-2">
                                <div class="card ">
                                <img src="https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcR2lNS_iEMdGt3_sniovlhAtJvio4Xd5uIY6w&s" class="card-img-top" alt="...">
                                <div class="card-body">
                                  <h5 class="card-title">Card title</h5>
                                  <p class="card-text">Some quick example text to build on the card title and make up the bulk of the card's content.</p>
                                  <a href="detalle_carrito.html" class="btn btn-primary">Ver Detalles</a>
                            ...
                            <div class="col-lg-3 col-md-4 col-sm-6 p-2">
                                <div class="card ">
                                <img src="https://img.ltwebstatic.com/images3_pi/2021/05/19/162140383976122b91be7edb96e6eb7e50e1b393be_thumbnail_720x.webp" class="card-img-top" alt="...">
                                <div class="card-body">
                                  <h5 class="card-title">Card title</h5>
                                  <p class="card-text">Some quick example text to build on the card title and make up the bulk of the card's content.</p>
                                  <a href="detalle_carrito.html" class="btn btn-primary">Ver Detalles</a>
                            ...
                            <div class="col-lg-3 col-md-4 col-sm-6 p-2">
                                <div class="card ">  
                                <img src="https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcSKZiAxmT7y2SVxMMoxtsUVjIuhir4Xai45cw&s" class="card-img-top" alt="...">
                                <div class="card-body">
                                  <h5 class="card-title">Card title</h5>
                                  <p class="card-text">Some quick example text to build on the card title and make up the bulk of the card's content.</p>
                                  <a href="detalle_carrito.html" class="btn btn-primary">Ver Detalles</a>
                            ...
                            <div class="col-lg-3 col-md-4 col-sm-6 p-2">
                                <div class="card ">
                                <img src="https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcRdeIB1r_0rJAO-tvkwnezRB6PtGbp1jgSWkQ&s" class="card-img-top" alt="...">
                                <div class="card-body">
                                  <h5 class="card-title">Card title</h5>
                                  <p class="card-text">Some quick example text to build on the card title and make up the bulk of the card's content.</p>
                                  <a href="detalle_carrito.html" class="btn btn-primary">Ver Detalles</a>
                            ...
                            <div class="col-lg-3 col-md-4 col-sm-6 p-2">
                                <div class="card ">
                                <img src="https://img.ltwebstatic.com/images3_pi/2023/09/02/d8/16936318111ce0ec9e8a0c9bc55fb75ab8e77e148b_thumbnail_720x.webp" class="card-img-top" alt="...">
                                <div class="card-body">
                                  <h5 class="card-title">Card title</h5>
                                  <p class="card-text">Some quick example text to build on the card title and make up the bulk of the card's content.</p>
                                  <a href="detalle_carrito.html" class="btn btn-primary">Ver Detalles</a>
                            ...
                            <div class="col-lg-3 col-md-4 col-sm-6 p-2">
                                <div class="card ">
                                <img src="https://img.ltwebstatic.com/images3_pi/2023/07/04/16884473978bdae9d3d6ee3e5621d7bbe7ed3362d2_thumbnail_720x.webp" class="card-img-top" alt="...">
                                <div class="card-body">
                                  <h5 class="card-title">Card title</h5>
                                  <p class="card-text">Some quick example text to build on the card title and make up the bulk of the card's content.</p>
                                  <a href="detalle_carrito.html" class="btn btn-primary">Ver Detalles</a>
                            ...
                            <div class="col-lg-3 col-md-4 col-sm-6 p-2">
                                <div class="card ">
                                <img src="https://img.ltwebstatic.com/images3_pi/2023/06/15/1686792943b8b9c95c402c22b1a94eec061545e7c0_thumbnail_720x.webp" class="card-img-top" alt="...">
                                <div class="card-body">
                                  <h5 class="card-title">Card title</h5>
                                  <p class="card-text">Some quick example text to build on the card title and make up the bulk of the card's content.</p>
                                  <a href="detalle_carrito.html" class="btn btn-primary">Ver Detalles</a>
                            ...
                            <div class="col-lg-3 col-md-4 col-sm-6 p-2">
                                <div class="card ">
                                <img src="https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcQXsTa74Q7Q3PUCmTkahIGw5JujIN3BLcjQsA&s" class="card-img-top" alt="...">
                                <div class="card-body">
                                  <h5 class="card-title">Card title</h5>
                                  <p class="card-text">Some quick example text to build on the card title and make up the bulk of the card's content.</p>
                                  <a href="detalle_carrito.html" class="btn btn-primary">Ver Detalles</a>
                            ...
                            <div class="col-lg-3 col-md-4 col-sm-6 p-2">
                                <div class="card ">
                                <img src="https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcTgc8AEvMrNd5BE0WPCX_9zpTPltktVK8wa-A&s" class="card-img-top" alt="...">
                                <div class="card-body">
                                  <h5 class="card-title">Card title</h5>
                                  <p class="card-text">Some quick example text to build on the card title and make up the bulk of the card's content.</p>
                                  <a href="detalle_carrito.html" class="btn btn-primary">Ver Detalles</a>
                            ...
                            <div class="col-lg-3 col-md-4 col-sm-6 p-2">
                                <div class="card ">
                                <img src="https://img.ltwebstatic.com/images3_pi/2021/06/24/16245129644f2db04a2efb75707d165f8bf7d130b1_thumbnail_720x.jpg" class="card-img-top" alt="...">
                                <div class="card-body">
                                  <h5 class="card-title">Card title</h5>
                                  <p class="card-text">Some quick example text to build on the card title and make up the bulk of the card's content.</p>
                                  <a href="detalle_carrito.html" class="btn btn-primary">Ver Detalles</a>
                            ...
                            <div class="col-lg-3 col-md-4 col-sm-6 p-2">
                                <div class="card ">
                                <img src="https://img.ltwebstatic.com/images3_pi/2024/01/06/32/17045217583e9af9eef1cb7f69f10fe04bbcfdc799_thumbnail_336x.jpg" class="card-img-top" alt="...">
                                <div class="card-body">
                                  <h5 class="card-title">Card title</h5>
                                  <p class="card-text">Some quick example text to build on the card title and make up the bulk of the card's content.</p>
                                  <a href="detalle_carrito.html" class="btn btn-primary">Ver Detalles</a>
                            ...
                            <div class="col-lg-3 col-md-4 col-sm-6 p-2">
                                <div class="card ">
                                <img src="https://i.pinimg.com/originals/78/b4/47/78b447b3c74d592f4f387a5d5457ea64.webp" class="card-img-top" alt="...">
                                <div class="card-body">
                                  <h5 class="card-title">Card title</h5>
                                  <p class="card-text">Some quick example text to build on the card title and make up the bulk of the card's content.</p>
                                  <a href="detalle_carrito.html" class="btn btn-primary">Ver Detalles</a>
                            ...
                            <div class="col-lg-3 col-md-4 col-sm-6 p-2">
                                <div class="card ">
                                <img src="https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcSqncd4ADIaD7aICcjuc7l3hYFIwLoVNTpIEw&s" class="card-img-top" alt="...">
                                <div class="card-body">
                                  <h5 class="card-title">Card title</h5>
                                  <p class="card-text">Some quick example text to build on the card title and make up the bulk of the card's content.</p>
                                  <a href="detalle_carrito.html" class="btn btn-primary">Ver Detalles</a>
                            ...
                            <div class="col-lg-3 col-md-4 col-sm-6 p-2">
                                <div class="card ">
                                <img src="https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcTpbqiFJixKqha8ZZnpDmIaM59WVdIGmaWaUg&s" class="card-img-top" alt="...">
                                <div class="card-body">
                                  <h5 class="card-title">Card title</h5>
                                  <p class="card-text">Some quick example text to build on the card title and make up the bulk of the card's content.</p>
                                  <a href="detalle_carrito.html" class="btn btn-primary">Ver Detalles</a>
                            ...
                            <div class="col-lg-3 col-md-4 col-sm-6 p-2">
                                <div class="card ">
                                <img src="https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcSfAz3zKzpvHFf_EDiRMPALmVC9mo5-7YSYfA&s" class="card-img-top" alt="...">
                                <div class="card-body">
                                  <h5 class="card-title">Card title</h5>
                                  <p class="card-text">Some quick example text to build on the card title and make up the bulk of the card's content.</p>
                                  <a href="detalle_carrito.html" class="btn btn-primary">Ver Detalles</a>
                            ...
                            <div class="col-lg-3 col-md-4 col-sm-6 p-2">
                                <div class="card ">
                                <img src="https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcQOBIHu0sqPf8YkptyZb4we6DN7NrBOP_v_ZA&s" class="card-img-top" alt="...">
                                <div class="card-body">
                                  <h5 class="card-title">Card title</h5>
                                  <p class="card-text">Some quick example text to build on the card title and make up the bulk of the card's content.</p>
                                  <a href="detalle_carrito.html" class="btn btn-primary">Ver Detalles</a>
